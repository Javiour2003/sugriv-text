...
from src.transformers.gpt.masked_multiheaded_attention import MaskedMultiHeadAttention
from src.transformers.gpt.positional_feed_forward_network import PositionwiseFeedForwardNetwork

class DecoderLayer(nn.Module):
    """
    Transformer decoder layer.
    """
    def __init__(self, d_model=1024, n_heads=1, ff_dim=10, dropout=0.1):
        """
