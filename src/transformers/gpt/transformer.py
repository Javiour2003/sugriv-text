...
from src.transformers.gpt.decoder_layer import DecoderLayer
from src.transformers.gpt.positional_encoding import PositionalEncoding
...
class Transformer(nn.Module):
    ...
    def forward(self, input):
        ...
        attention_mask = self.create_causal_mask(self.batch_size, self.max_seq_len)
    ...
    def create_causal_mask(self,batch_size, seq_length):
        ...
        mask = torch.triu(torch.ones(seq_length, seq_length)) == 0
